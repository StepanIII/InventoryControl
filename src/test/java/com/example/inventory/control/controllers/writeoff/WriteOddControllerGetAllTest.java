...
public class WriteOddControllerGetAllTest extends AbstractTest {
    ...
    public void shouldGetAllRemaining() {
        ...
        List<WriteOffResponse> writeOffResponses = response.getBody().getWriteOffs();
    ...
    private void assertWriteOff(WriteOffResponse verifiable, WriteOffEntity expected) {
