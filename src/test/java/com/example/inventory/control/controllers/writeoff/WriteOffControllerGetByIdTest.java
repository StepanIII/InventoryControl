...
//        ResponseEntity<WriteOffResourcesBody> responseEntity = restTemplate.getForEntity(
//                WRITE_OFF_ENDPOINT + "/{id}",
//                WriteOffResourcesBody.class,
//                writeOffId);
//
//        assertThat(responseEntity).isNotNull()
//                .matches(r -> r.getStatusCode().is2xxSuccessful());
//        WriteOffResourcesBody body = responseEntity.getBody();
