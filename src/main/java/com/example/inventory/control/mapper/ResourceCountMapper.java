...
public abstract class ResourceCountMapper {
    ...
    public ResourceCount toDomain(ResourceCountEntity entity) {
        return new ResourceCount(entity.getId(), entity.getResource().getId(), entity.getResource().getSize(), entity.getResource().getName(), entity.getResource().getUnit(), entity.getCount());
    }
    ...
    public ResourceCountResponseBodyModel toResponse(ResourceCount domainModel) {
        ...
        response.setSize(domainModel.size().orElse(null));
        response.setUnit(domainModel.getUnit().getValue());
