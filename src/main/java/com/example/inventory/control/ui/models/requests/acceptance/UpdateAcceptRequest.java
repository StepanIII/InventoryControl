 ...
 */
public class UpdateAcceptRequest {
    ...
    public UpdateAcceptRequest() {
    }

    public UpdateAcceptRequest(Long benefactorId, Long warehouseId, List<ResourceCountRequest> resources) {
